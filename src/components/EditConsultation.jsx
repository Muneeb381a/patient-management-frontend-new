...
import { Loader, InlineLoader } from "../pages/Loader";
...
const FormField = ({
  ...
  <div className="mb-4">
    ...
    <input
      ...
      required={required}
      className={[
        "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 shadow-sm",
        "transition-colors focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500",
        urdu ? "text-right" : "",
        disabled ? "bg-gray-100 cursor-not-allowed" : "bg-white",
      ].join(" ")}
      style={urdu ? { fontFamily: "'Noto Nastaliq Urdu', sans-serif" } : undefined}
    />
  </div>
);
...
const CheckboxField = ({ label, checked, onChange }) => (
  <div className="flex items-center gap-2 mb-4">
    <input
      ...
      className="h-4 w-4 rounded border-gray-300 cursor-pointer accent-teal-600"
    />
  ...
  return (
    ...
    >
      ...
      <select
        ...
        className={[
          "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white shadow-sm",
          "transition-colors focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500",
          urdu ? "text-right" : "",
        ].join(" ")}
        required={required}
...
const EditConsultation = () => {
  ...
  if (editLoading && !editFormData) {
    return <Loader message="Loading consultation..." />;
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-start justify-center p-4 py-8">
      <motion.div
      ...
      >
        {editLoading && <Loader message="Saving changes..." />}
        {/* Page header */}
        <div className="px-8 py-5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-indigo-600 to-teal-500">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Edit Consultation</h2>
              <p className="text-indigo-100 text-xs mt-0.5">Update patient consultation details</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 pt-4 space-y-3">
          ...
          {symptomsError && (
            <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-4 py-3 text-sm">
              <FaTimes className="text-amber-500 mt-0.5 shrink-0" />
              <span className="flex-1">{symptomsError}</span>
              <button onClick={() => setSymptomsError("")} className="text-amber-400 hover:text-amber-600 transition-colors">
                <FaTimes />
              </button>
            </div>
          )}
          {testsError && (
            <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-4 py-3 text-sm">
              <FaTimes className="text-amber-500 mt-0.5 shrink-0" />
              <span className="flex-1">{testsError}</span>
              <button onClick={() => setTestsError("")} className="text-amber-400 hover:text-amber-600 transition-colors">
                <FaTimes />
              </button>
            </div>
          )}
          {prescriptionsError && (
            <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 text-amber-800 rounded-xl px-4 py-3 text-sm">
              <FaTimes className="text-amber-500 mt-0.5 shrink-0" />
              <span className="flex-1">{prescriptionsError}</span>
              <button onClick={() => setPrescriptionsError("")} className="text-amber-400 hover:text-amber-600 transition-colors">
                <FaTimes />
              </button>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="px-8 py-6 flex flex-col gap-6">
            ...
            >
              ...
              {editFormData.vital_signs?.map((vital, index) => (
                <div
                  key={index}
                  className="mb-4 p-4 bg-white rounded-lg border border-gray-100 shadow-sm grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4"
                >
                  <FormField
            ...
            >
              <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-7 h-7 rounded-lg bg-blue-100 flex items-center justify-center">
                  <FaStethoscope className="text-blue-500 text-xs" />
                </span>
                Symptoms
              </h3>
              <SymptomsSelector
            ...
            >
              <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-7 h-7 rounded-lg bg-green-100 flex items-center justify-center">
                  <FaFlask className="text-green-600 text-xs" />
                </span>
                Tests
              </h3>
              <TestsSelector
            ...
            >
              <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-7 h-7 rounded-lg bg-purple-100 flex items-center justify-center">
                  <FaBrain className="text-purple-600 text-xs" />
                </span>
                Neurological Examination
              </h3>
            ...
            >
              <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-7 h-7 rounded-lg bg-amber-100 flex items-center justify-center">
                  <FaPills className="text-amber-600 text-xs" />
                </span>
                Prescriptions
              </h3>
              {editFormData.prescriptions?.map((med, index) => (
                <motion.div
                  ...
                  className="mb-3 p-4 bg-white rounded-lg border border-gray-100 shadow-sm flex flex-wrap gap-4 items-end hover:shadow-md transition-shadow"
                >
                  ...
                  <button
                    ...
                    className="text-red-400 hover:text-red-600 hover:scale-110 transition-all p-1 self-end mb-4"
              ...
              <button
                type="button"
                onClick={addMedicine}
                className="mt-2 inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
            ...
            >
              <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-7 h-7 rounded-lg bg-orange-100 flex items-center justify-center">
                  <FaNotesMedical className="text-orange-500 text-xs" />
                </span>
                Diagnosis
              </h3>
              <FormField
            ...
            >
              <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <span className="w-7 h-7 rounded-lg bg-pink-100 flex items-center justify-center">
                  <FaNotesMedical className="text-pink-500 text-xs" />
                </span>
                Follow-ups
              </h3>
              ...
              {editFormData.follow_ups?.length > 0 ? (
                editFormData.follow_ups.map((followUp, index) => {
                  ...
                  const handlePredefinedChange = (value) => {
                    ...
                    setPredefinedSelections((prev) => ({ ...prev, [index]: value }));
                  };

                  const handleDateChange = (value) => {
                    if (predefinedSelections[index]) {
                      setPredefinedSelections((prev) => ({ ...prev, [index]: "" }));
                    }
                  ...
                  return (
                    <div
                      key={index}
                      className="mb-3 p-4 bg-white rounded-lg border border-gray-100 shadow-sm grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4"
                    >
                      <div>
                        <label
                        ...
                        <div className="flex gap-2 flex-wrap">
                          <select
                            ...
                            className="flex-1 min-w-[180px] px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                            style={{ fontFamily: "'Noto Nastaliq Urdu', sans-serif" }}
                          >
                          ...
                          <input
                            ...
                            className="flex-1 min-w-[160px] px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                          />
                        </div>
                      </div>
                      <FormField
                        ...
                        placeholder="Enter notes"
                        value={followUp.notes}
                        onChange={(val) => updateField("follow_ups", index, "notes", val)}
                      />
              ...
              >
                <FaPlus className="text-xs" /> Add Follow-up
              </button>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex justify-end gap-3 pt-2 pb-4 border-t border-gray-100"
            >
              <button
                type="button"
                onClick={handleCancel}
              ...
              <button
                type="submit"
                disabled={editLoading}
                className="inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-teal-500 hover:from-indigo-700 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
              >
